...
public class BasicFigures {
	...
	private static Canvas createDiagram(Composite parent) {
		...
		PolygonDecoration ps = new PolygonDecoration();
		ps.setTemplate(PolygonDecoration.INVERTED_TRIANGLE_TIP);
		ps.setSize(100, 100);
...
//		ps.addPoint(r.getTop());
		ps.setFill(true);
		ps.setBackgroundColor(ColorConstants.lightBlue);
		ps.setPreferredSize(r.getSize());
		root.add(ps, new Rectangle(new Point(80, 10),ps.getPreferredSize()));
