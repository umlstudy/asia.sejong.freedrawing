	...
	public static void main (String [] args) {
		...
		shell.addListener (SWT.Paint, new Listener () {
			...
			public void handleEvent (Event e) {
				...
				Pattern p = new Pattern (e.display, x, y, x, y+(1*rect.height), background, 0, background, 255);
...
//				 p = new Pattern (e.display, x, y+rect.height, x, y+(2*rect.height), background, 0, background, 255);
//				gc.setBackgroundPattern (p);
