...
public class FDRectangeEditPart extends AbstractFDElementEditPart {
	...
	public FDRectangle getModel() {
		return (FDRectangle) super.getModel();
	}
	...
	//
	// /**
	// * Answer a collection of connection model objects that originate with the
	// receiver.
	// */
	// public List<GenealogyConnection> getModelSourceConnections() {
	// Person person = getModel();
	// Marriage marriage = person.getMarriage();
	// ArrayList<GenealogyConnection> marriageList = new
	// ArrayList<GenealogyConnection>(1);
	// if (marriage != null)
	...
	//
	// /**
	// * Return an instance of {@link ChopboxAnchor} so that the connection
	// originates along
	// * the {@link PersonFigure}'s bounding box. This is called once a
	// connection has been
	// * established.
	// */
	...
	// return null;
	// GenealogyConnectionEditPart connPart = (GenealogyConnectionEditPart)
	// part;
	...
	// ArrayList<GenealogyConnection> offspringList = new
	// ArrayList<GenealogyConnection>();
	// Person person = getModel();
	...
	//
	// /**
	// * If this request is creating a connection from a {@link
	// MarriageEditPart} to the
	// * receiver, then return an instance of {@link ChopboxAnchor} so that the
	// connection
	// * creation snaps to the figure and terminates along the {@link
	// PersonFigure}'s
	// * bounding box. If the connection source is NOT from a {@link
	// MarriageEditPart} then
	// * return <code>null</code> so that the connection does not appear to
	...
	// NoteContainer oldContainer = (NoteContainer)
	...
	// return null;
	// }
	// ReorderNoteCommand cmd = new ReorderNoteCommand(getModel(), (Note)
	// child.getModel());
	// if (after != null)
	// cmd.setAfterNote((Note) after.getModel());
	// return cmd;
	...
	// PersonGraphicalNodeEditPolicy(getModel()));
	// }
	//
	// /**
	...
	// */
	// public void parentsMarriageChanged(Marriage marriage, Marriage
	// oldMarriage) {
	// ConnectionEditPart part = findConnection(getModel(), oldMarriage);
	// if (part != null)
