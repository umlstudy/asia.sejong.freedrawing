 ...
 */
public abstract class FDTextShapeFigureImpl extends FDShapeFigureImpl implements PositionConstants, FDTextShapeFigure {
	 ...
	 * @since 2.0
	 */
	public FDTextShapeFigureImpl(String s) {
		setText(s);
	}
	 ...
	 * @since 2.0
	 */
	public FDTextShapeFigureImpl(Image i) {
		setIcon(i);
	}
	 ...
	 * @since 2.0
	 */
	public FDTextShapeFigureImpl(String s, Image i) {
		setText(s);
		setIcon(i);
	}
...
//		graphics.translate(bounds.x, bounds.y);
		...
		Point textLocation = getTextLocation().getCopy();
...
//		graphics.translate(-bounds.x, -bounds.y);
	...
	// -----------------------------------------------------------
	// FDTextShapeFigure Implementation
	...
	@Override
	public final void setTextEx(String text) {
		setText(text);
	}
