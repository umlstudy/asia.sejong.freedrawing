...
public class SquareButtonTestDialog extends ApplicationWindow {
	private static String IMG1_PATH = "./pinstripes.png";
	private static String IMG2_PATH = "./tango-face-glasses.png";
	...
	protected Control createContents(Composite parent) {
		...
		Image image = new Image(getShell().getDisplay(), this.getClass().getResourceAsStream(IMG1_PATH));
		...
		image = new Image(getShell().getDisplay(),  this.getClass().getResourceAsStream(IMG2_PATH));
